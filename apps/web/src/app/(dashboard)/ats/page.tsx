  ...
  const analyzeResume = async () => {
    ...
    try {
      ...
      try {
        ...
        alert('❌ Resume analysis failed. Please try again or check your internet connection.');
      }
    } finally {
              ...
              <>
                ...
                <div className="flex items-center justify-center space-x-3 flex-wrap">
                  <button 
                    ...
                    className="px-6 py-3 rounded-xl transition-all hover:opacity-80 text-sm font-semibold flex items-center space-x-2"
                    style={{
                  ...
                  <button 
                    ...
                    className="px-4 py-2 rounded-xl transition-all hover:opacity-80 text-sm"
